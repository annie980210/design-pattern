 ...
 * com.holub.database.ConcreteTable#ConcreteTable(Table.Importer)} to initialize
 * a <code>Table</code> from a comma-sparated-value repressentation. For
 * example:
 * 
 * <PRE>
 ...
 * </PRE>
 * 
 * The input file for a table called "name" with columns "first," "last," and
