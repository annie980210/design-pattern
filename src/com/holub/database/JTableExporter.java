...
/***
 * A class that demonstrates using an Exporter to create a UI. The following
 * code creates and populates a table, then creates a {@link JTable} that holds
 * a representation of the {@link Table}.
 * 
 * <PRE>
...
public class JTableExporter implements Table.Exporter {
	...
	/**
	 * Return the Concrete Product of this builder---a JTable initialized with the
	 * table data.
	 */
	 ...
	 * com.holub.database.JTableExporter\$Test</em>.
	 */
