...
public class UnmodifiableTable implements Table {
	 ...
	 *
	 */
	private static final long serialVersionUID = 7390660388642391357L;
	...
	/**
	 * Extract the wrapped table. The existence of this method is problematic, since
	 * it allows someone to defeat the unmodifiability of the table. On the other
	 * hand, the wrapped table came in from outside, so external access is possible
	 * through the reference that was passed to the constructor. Use the method with
	 * care.
	 */
