...
/**
 * Matches a simple symbol that doesn't have to be on a "word" boundary;
 * punctuation, for example. SimpleToken is very efficient, but does not
 * recognize characters in a case-insensitive way, as does {@link WordToken} and
 * {@link RegexToken}.
 *
